...
#define WPAD_CLASSIC_BUTTON_FULL_R				(0x0002<<16)
#define WPAD_CLASSIC_BUTTON_PLUS				(0x0004<<16)
#define WPAD_CLASSIC_BUTTON_HOME				(0x0008<<16)
#define WPAD_CLASSIC_BUTTON_MINUS				(0x0010<<16)
#define WPAD_CLASSIC_BUTTON_FULL_L				(0x0020<<16)
#define WPAD_CLASSIC_BUTTON_DOWN				(0x0040<<16)
#define WPAD_CLASSIC_BUTTON_RIGHT				(0x0080<<16)
#define WPAD_CLASSIC_BUTTON_UP					(0x0100<<16)
#define WPAD_CLASSIC_BUTTON_LEFT				(0x0200<<16)
#define WPAD_CLASSIC_BUTTON_ZR					(0x0400<<16)
#define WPAD_CLASSIC_BUTTON_X					(0x0800<<16)
#define WPAD_CLASSIC_BUTTON_A					(0x1000<<16)
#define WPAD_CLASSIC_BUTTON_Y					(0x2000<<16)
#define WPAD_CLASSIC_BUTTON_B					(0x4000<<16)
#define WPAD_CLASSIC_BUTTON_ZL					(0x8000<<16)

#define WPAD_GUITAR_HERO_3_BUTTON_PLUS			(0x0004<<16)
#define WPAD_GUITAR_HERO_3_BUTTON_MINUS			(0x0010<<16)
#define WPAD_GUITAR_HERO_3_BUTTON_STRUM_DOWN	(0x0040<<16)
#define WPAD_GUITAR_HERO_3_BUTTON_STRUM_UP		(0x0100<<16)
#define WPAD_GUITAR_HERO_3_BUTTON_YELLOW		(0x0800<<16)
#define WPAD_GUITAR_HERO_3_BUTTON_GREEN			(0x1000<<16)
#define WPAD_GUITAR_HERO_3_BUTTON_BLUE			(0x2000<<16)
#define WPAD_GUITAR_HERO_3_BUTTON_RED			(0x4000<<16)
#define WPAD_GUITAR_HERO_3_BUTTON_ORANGE		(0x8000<<16)

#define WPAD_WIIU_PRO_BUTTON_R					(0x0002<<16)
#define WPAD_WIIU_PRO_BUTTON_PLUS				(0x0004<<16)
#define WPAD_WIIU_PRO_BUTTON_HOME				(0x0008<<16)
#define WPAD_WIIU_PRO_BUTTON_MINUS				(0x0010<<16)
#define WPAD_WIIU_PRO_BUTTON_L					(0x0020<<16)
#define WPAD_WIIU_PRO_BUTTON_DOWN				(0x0040<<16)
#define WPAD_WIIU_PRO_BUTTON_RIGHT				(0x0080<<16)
#define WPAD_WIIU_PRO_BUTTON_UP					(0x0100<<16)
#define WPAD_WIIU_PRO_BUTTON_LEFT				(0x0200<<16)
#define WPAD_WIIU_PRO_BUTTON_ZR					(0x0400<<16)
#define WPAD_WIIU_PRO_BUTTON_X					(0x0800<<16)
#define WPAD_WIIU_PRO_BUTTON_A					(0x1000<<16)
#define WPAD_WIIU_PRO_BUTTON_Y					(0x2000<<16)

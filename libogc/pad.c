		...
		case PAD_ERR_NO_CONTROLLER:
			...
			case SI_N64_CONTROLLER:
				...
				case N64_ERR_READY:
					...
					if(n64status[i].button&N64_TRIGGER_Z)		state |= PAD_TRIGGER_Z;
					if(n64status[i].button&N64_TRIGGER_R)		state |= PAD_TRIGGER_R | PADEX_TRIGGER_R;
					if(n64status[i].button&N64_TRIGGER_L)		state |= PAD_TRIGGER_L | PADEX_TRIGGER_L;

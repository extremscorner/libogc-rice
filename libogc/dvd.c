...
dvdcallbacklow DVD_LowClearCallback()
{
	dvdcallbacklow old;
...
static bool __gcdvd_Startup()
{
	DVD_Init();
	return true;
}

static bool __gcdvd_IsInserted()
{
	u32 status = 0;
...
static bool __gcdvd_ClearStatus()
{
	return true;
}

static bool __gcdvd_Shutdown()
{
	dvdcmdblk blk;
	DVD_StopMotor(&blk);
	return true;
